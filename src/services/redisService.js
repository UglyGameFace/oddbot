...
function createRedisClient() {
  ...
  const redisOptions = {
    ...
    reconnectOnError: (err) => {
      ...
      // For other errors, use ioredis default behavior
      return false;
    },
...
// FIX: Export as both named and default
